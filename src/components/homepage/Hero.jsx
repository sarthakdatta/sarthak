...
import mainImg from "/src/assets/images/main.jpg";
  ...
  return (
    <section id="hero" className="hero relative flex w-full h-screen select-none items-center justify-center" aria-label="hero">
      ...
      >
        <img
          ref={img}
          className=" scale-110 aspect-[11/16] sm:aspect-[5/6] md:aspect-[7/7] rounded-md opacity-80 lg:aspect-[11/9] w-full h-auto"
          src={mainImg}
